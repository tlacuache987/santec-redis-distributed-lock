package mx.com.santander.arquitecturatecnica.redis.distributedlock;
...
public interface Lock {
	 ...
	 *
	 * @param keys
	 *            keys to try to lock (suffix)
	 * @param storeId
	 *            lock store id to save keys in (prefix)
	 * @param expiration
	 *            how long to wait before releasing the key automatically, in millis
	 ...
	 * 
	 * @param keys
	 *            keys to try to unlock
	 * @param token
	 *            token used to check if lock is still held by this lock
	 * @param storeId
	 *            lock store id to save keys in (table, collection, ...)
